            ...
            <div>
              ...
              <div className={style.user}>
                <div className={style.info}>
                  <img src={'https://picsum.photos/' + props.user.id + '0'} alt="" />
                  <h2>Status:</h2>
                ...
                p.userId == '1' ? (
                  <div
                    ...
                    <div className={style.comments}>
                      {props.comments &&
                      props.comments[Math.floor(Math.random() * Math.floor(5))] ? (
                        <>
                          {' '}
                          <img
                            ...
                            alt=""
                          />
                          <p>{props.comments[Math.floor(Math.random() * Math.floor(5))]['name']}</p>
                        </>
                      ) : (
                        console.log()
                      )}
